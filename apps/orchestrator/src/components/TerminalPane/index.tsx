...
export const TerminalPane = memo(function TerminalPane({
  ...
  useEffect(() => {
    ...
    window.addEventListener('flashwork:terminal-restart-request', onRestartRequest)
    return () => window.removeEventListener('flashwork:terminal-restart-request', onRestartRequest)
  })
            ...
            <>
              {useNativeBackend && !activeTab.handoff ? (
                ...
                <XTermView
                  ...
                  sessionCreate={activeTab.sessionCreate}
                  lockOwnerId={terminal.id}
