...
export function PrivateBrowserSurface({
  ...
  useEffect(() => {
    ...
    const startWebview = () => {
      ...
      void instance
        .once<string>('tauri://error', (event) => {
          ...
          if (import.meta.env.DEV) console.error('[Flashwork][private-browser]', detail)
    ...
    window.addEventListener('flashwork:zoom-changed', scheduleSync)
    scheduleSync()
    ...
    return () => {
      ...
      window.removeEventListener('flashwork:zoom-changed', scheduleSync)
