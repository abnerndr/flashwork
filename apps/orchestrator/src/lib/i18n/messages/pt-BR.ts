...
export const ptBR: Record<MessageKey, string> = {
  ...
  'onboarding.gitSubtitle': 'Veja mudanças, prepare arquivos e crie commits sem sair do Flashwork.',
  ...
  'profiles.backupFileType': 'Backup de conta Flashwork',
  ...
  'remote.description':
    'Escaneie este QR code com um celular na mesma rede para abrir o Flashwork Remote.',
  ...
  'onboarding.agentsMissing':
    'O Flashwork usa suas próprias contas e assinaturas dos provedores. Faltou uma CLI ou escolheu o executável errado? Procure novamente ou altere depois em Preferências > Terminal > Caminhos das CLIs.',
  'onboarding.agentsRescan': 'Procurar de novo',
  'agentInstall.needsNode':
    'Este agente precisa de Node.js 20+ e npm. Instale ou atualize o Node e tente de novo.',
  ...
  'handoff.privacy':
    'O pacote fica no seu perfil local do Flashwork e é apagado após o primeiro turno concluído pelo agente de destino.',
  'handoff.lossPrivate':
  ...
  'remote.settingsStatusDesc': 'Controle se o Flashwork aceita conexões remotas na rede local.',
  ...
  'prefs.categoryAccountDesc': 'Gerencie seu perfil local, idioma e contas do Flashwork.',
  ...
  'prefs.uiThemeDesc': 'Escolha a paleta usada em toda a interface do Flashwork.',
  ...
  'prefs.windowOpacityDesc': 'Deixe o desktop aparecer através de toda a janela do Flashwork.',
  ...
  'prefs.featuresDesc': 'Escolha quais módulos opcionais ficam visíveis no Flashwork.',
  ...
  'features.taskBoard.title': 'Quadro de tarefas',
  'features.taskBoard.description':
    'Fila Kanban que planeja com um modelo barato e executa o trabalho nos CLIs instalados.',
  'features.canvasFlows.title': 'Fluxos (beta)',
  'features.canvasFlows.description':
    'Grafos de agentes, texto, filtros, HTTP e ferramentas MCP. A saída de um nó alimenta o próximo.',
  ...
  'taskBoard.prompt': 'O que deve acontecer',
  'taskBoard.files': 'Arquivos permitidos',
  'taskBoard.addFiles': 'Adicionar arquivos',
  'taskBoard.filesHint': 'Vazio significa o repo inteiro — este card roda sozinho nessa pasta.',
  'taskBoard.verify': 'Comandos de teste (opcional)',
  'taskBoard.verifyHint': 'Um comando por linha. Se vazio, usa a validação do projeto.',
  'taskBoard.attachHandoff': 'Anexar handoff',
  'taskBoard.attachNeedPromptOrFile': 'Escreva um prompt ou anexe um arquivo antes de criar o card.',
  'taskBoard.attachmentsHint': 'Handoffs em markdown que o agente lê quando o card começa.',
  'taskBoard.attachOnlyPrompt': 'Ver anexo: {title}',
  'taskBoard.restrictTools': 'Restringir ferramentas',
  'taskBoard.toolsDefault': 'Usa os padrões do projeto para servidores MCP e skills.',
  'taskBoard.toolsMcpServers': 'Servidores MCP',
  'taskBoard.toolsSkills': 'Skills',
  'taskBoard.toolsEmptyServers': 'Nenhum servidor MCP encontrado para este projeto.',
  'taskBoard.toolsEmptySkills': 'Nenhuma skill encontrada.',
  'taskBoard.create': 'Adicionar ao backlog',
  'taskBoard.fileCount': '{count} arquivos',
  'taskBoard.wholeRepo': 'Repo inteiro',
  'taskBoard.openWorkspace': 'Abrir workspace',
  'taskBoard.stop': 'Parar',
  'taskBoard.column.backlog': 'Backlog',
  'taskBoard.column.todo': 'A fazer',
  'taskBoard.column.doing': 'Fazendo',
  'taskBoard.column.verify': 'Testar',
  'taskBoard.column.done': 'Feito',
  'taskBoard.column.blocked': 'Bloqueado',
  'taskBoard.error.noCwd':
    'Este projeto não tem pasta de trabalho. Abra o workspace ou escolha uma pasta e volte o card para A fazer.',
  ...
  'flows.title': 'Fluxos',
  'flows.kicker': 'Canvas beta',
  'flows.lede': 'Arraste um nó para o quadro. Ligue a saída na entrada. Executar passa um nó por vez.',
  'flows.beta': 'Beta',
  'flows.graph': 'Fluxo',
  'flows.new': 'Novo fluxo',
  'flows.run': 'Executar',
  'flows.running': 'Executando…',
  'flows.inspector': 'Nó',
  'flows.inspectorEmpty': 'Selecione um nó para editar as configurações.',
  'flows.portIn': 'Porta de entrada',
  'flows.portOut': 'Porta de saída',
  'flows.confirmHosts':
    'Este fluxo vai chamar: {hosts}. Continue só se você confiar nesses hosts.',
  'flows.loopbackOn': 'HTTP em loopback (127.0.0.1) está permitido nos nós de Fluxo.',
  'flows.loopbackOff': 'Permitir que nós HTTP de Fluxo chamem http://127.0.0.1 após confirmação.',
  'flows.node.agent': 'Agente',
  'flows.node.text': 'Texto',
  'flows.node.filter': 'Filtro',
  'flows.node.http': 'HTTP',
  'flows.node.mcp': 'Ferramenta MCP',
  'flows.field.prompt': 'Prompt',
  'flows.field.template': 'Modelo ({{input}})',
  'flows.field.includes': 'Inclui',
  'flows.field.regex': 'Regex',
  'flows.field.jsonPath': 'Caminho JSON',
  'flows.field.method': 'Método',
  'flows.field.url': 'URL',
  'flows.field.server': 'Servidor MCP',
  'flows.field.serverEmpty': 'Selecione um servidor configurado',
  'flows.field.tool': 'Nome da ferramenta',
  ...
  'prefs.resourcePolicyManualHint':
    'O Flashwork apenas mede o consumo. Ele nunca fecha abas, estaciona runtimes nem pausa novos processos automaticamente.',
  ...
  'prefs.cliPathsDesc':
    'O Flashwork encontra o CLI de cada agente sozinho. Só defina um caminho se o CLI estiver num lugar fora do comum — e aponte para a ferramenta de linha de comando, não para o aplicativo gráfico.',
  ...
  'prefs.cliCommandDesc':
    "Instale o comando 'flashwork' pra abrir qualquer pasta como projeto direto do terminal.",
  ...
  'prefs.cliStale':
    'O comando instalado aponta pra uma cópia antiga do Flashwork. Reinstale pra atualizar o caminho.',
  'prefs.cliNotOnPath':
  ...
  'prefs.checkUpdatesDesc':
    'Verifique se uma versão mais recente do Flashwork está disponível para baixar.',
  'prefs.installedVersion': 'Versão instalada',
  'prefs.checkNow': 'Procurar atualizações',
  'prefs.checkingUpdates': 'Procurando…',
  'prefs.upToDate': 'O Flashwork está atualizado.',
  ...
  'todo.resetDefault': 'Resetar para Todo padrão do Flashwork',
  'todo.resetDefaultConfirm': 'Substituir sua lista atual pelo Todo padrão do Flashwork?',
  ...
  'whatsNew.subtitle': 'A Flashwork está ficando cada vez melhor.',
  ...
  'whatsNew.v130.note8':
    'Controle experimental de opacidade da janela, para enxergar o desktop através do Flashwork.',
  ...
  'home.quickUnrestrictedAutoHint':
    'No Auto, os allows dos CLIs são aceitos automaticamente (YOLO). Escolha um agente específico para usar o modo Normal.',
  'home.quickAgentSessionHint': '{agent}: sessão {limit}',
  ...
  'promptRun.status.interrupted': 'Interrompido',
  ...
  'promptRun.reason.skill': 'Combinou com uma skill',
  'promptRun.reason.orchestrator': 'Orquestrador',
  'promptRun.barTitle': 'Run Auto',
  'promptRun.sessionLimitHint': 'Limite de sessão {agent}: {limit}',
  'promptRun.reviewCapsule': 'Revisar cápsula',
  'promptRun.cancel': 'Parar Auto',
  'promptRun.composerPlaceholder': 'Continuar com Auto…',
  ...
  'promptRun.handoffNoPeer': 'Nenhum outro CLI de código está instalado para continuar.',
  'interruptedResume.title': 'Retomar Auto interrompido',
  'interruptedResume.lede':
    'Estes runs do Auto ou do Quadro ainda estavam ativos quando o Flashwork saiu ou caiu. Retomar continua no Auto por até 7 dias.',
  'interruptedResume.resume': 'Retomar no Auto',
  'interruptedResume.discard': 'Descartar',
  'interruptedResume.dismissAll': 'Descartar todos',
  'interruptedResume.resumedTitle': 'Auto retomado',
  'interruptedResume.resumedBody': 'Um novo run Auto começou a partir do trabalho interrompido.',
  'interruptedResume.failedTitle': 'Não foi possível retomar',
  'interruptedResume.failedBody': 'Instale um CLI de código ou adicione uma chave de provedor e tente de novo.',
  'taskBoard.needsResume': 'Interrompido — retomar no Auto',
  'taskBoard.resumeAuto': 'Retomar no Auto',
  ...
  'widget.sessionWindowUsage': 'uso {window}',
  ...
  'widget.geminiNoUsage': 'sem uso hoje',
  'widget.geminiNoUsageHint': 'rode o gemini hoje para ver os tokens aqui',
  'widget.geminiTouchedToday': 'totais da sessão · tocada hoje',
  'widget.costLabel': 'custo',
  ...
  'crud.folderRequired': 'Escolha uma pasta para o projeto.',
  'crud.flashworkExists': 'Esta pasta já pertence a um projeto do Flashwork.',
  'crud.openExisting': 'Abrir esta pasta como projeto',
  ...
  'browser.resourceModeAppFirst': 'Priorizar o Flashwork',
  ...
  'browser.resourceModeDescription.keep-alive':
    'Mantém páginas ocultas carregadas, mas ainda as libera se o Flashwork detectar pressão de memória.',
  'browser.addToGrid': 'Adicionar ao grid',
  'browser.privateTitle': 'Sessão privada sempre ativa',
  'browser.privateDescription':
    'O Flashwork abre este pane em uma webview nativa anônima. Cookies, logins, cache, preenchimento automático e dados dos sites não são mantidos depois que o pane é fechado.',
  'browser.privateBadge': 'Privado',
  'browser.destination': 'Este browser será adicionado a {project}.',
  'browser.embedHint':
    'Abre dentro do Flashwork. Alguns sites podem bloquear a visualização incorporada.',
  ...
  'mod.health.normal.body':
    'O Windows tem {available} disponíveis de {total}. O Flashwork não fechará abas automaticamente.',
  ...
  'mod.health.critical.body':
    'O Windows tem apenas {available} disponíveis de {total}. O Flashwork avisará, mas qualquer encerramento de sessão continuará sendo sua decisão.',
  ...
  'appClose.title': 'Fechar o Flashwork?',
  'appClose.message':
    'Agentes e terminais abertos serão encerrados. As conversas salvas poderão ser retomadas quando você abrir o Flashwork novamente.',
  'appClose.confirm': 'Fechar o Flashwork',
  'appClose.cancel': 'Cancelar',
  'appClose.failedTitle': 'Não foi possível fechar o Flashwork',
  'appClose.failedBody':
  ...
  'ui.sidebar.tasks': 'Tarefas',
  'ui.sidebar.tasksTitle': 'Quadro de tarefas',
  'ui.sidebar.flows': 'Fluxos',
  'ui.sidebar.flowsTitle': 'Fluxos (beta)',
  ...
  'files.previewTooLarge':
    'Este arquivo é grande demais para uma visualização rápida. Abra-o pela barra de Arquivos.',
  ...
  'files.dragHint':
    '{path} — arraste para a área de trabalho, ou clique para abrir',
  ...
  'git.fetch.title': 'Buscar dos remotos',
  'git.fetch.done': 'Buscado dos remotos',
  'git.push.action': 'Push',
  'git.push.title': 'Enviar para o remoto',
  'git.push.done': 'Enviado para o remoto',
  'git.pull.action': 'Pull',
  'git.pull.title': 'Puxar do remoto',
  'git.pull.done': 'Puxado do remoto',
  'git.publish.action': 'Publicar',
  'git.publish.title': 'Publicar branch',
  'git.publish.done': 'Branch publicada',
  'git.origin.label': 'URL do origin',
  'git.origin.placeholder': 'https://github.com/owner/repo.git',
  'git.pullRequest.action': 'Abrir pull request',
  'git.pullRequest.title': 'Abrir pull request no GitHub',
  ...
  'git.github.signIn': 'Entrar no GitHub',
  'git.github.title': 'Entrar no GitHub',
  'git.github.hint': 'Copie o código e autorize o Flashwork no GitHub.',
  'git.github.copy': 'Copiar código',
  'git.github.copied': 'Copiado',
  'git.github.openDevice': 'Abrir GitHub',
  'git.github.starting': 'Iniciando login…',
  'git.github.waiting': 'Aguardando autorização…',
  ...
  'ws.confirmOverwriteForeignAgent':
    'Já existe um agent "{name}" neste projeto que NÃO foi criado pelo Flashwork. Sobrescrever?',
  'ws.confirmRemoveAgent': 'Remover o agent "{name}" do projeto?',
  'ws.confirmRemoveForeignAgent':
    'O agent "{name}" NÃO foi criado pelo Flashwork. Remover mesmo assim?',
  ...
  /* ---- crash watch ---- */
  'crash.uncleanTitle': 'O Flashwork fechou sozinho',
  ...
  'update.checkFailedBody':
    'O Flashwork não conseguiu acessar o serviço de atualização. Verifique sua conexão e tente novamente.',
  ...
  'prefs.aboutVersionDesc': 'A build do Flashwork instalada no momento.',
  'prefs.aboutUpdatesTitle': 'Atualizações',
  'prefs.aboutUpdatesDesc': 'Verifique e instale novas versões do Flashwork.',
  ...
  'update.checkSuccessTitle': 'O Flashwork está atualizado',
  ...
  'resource.warning.body':
    'O Flashwork está usando cerca de {total} MB. Runtimes ocultos e ociosos podem ser estacionados.',
  'resource.critical.title': 'Limite de memória atingido',
  'resource.critical.body':
    'O Flashwork está usando cerca de {total} MB. Novos runtimes ficarão pausados até a memória baixar.',
  ...
  'sandbox.subtitle':
    'Um POC real planner-to-worker: Claude Code planeja, Codex implementa e o Flashwork faz o relay.',
  ...
  'mcp.marketplaceHint':
    'Adicione servidores MCP pelo registry, instale skills a partir de uma pasta ou URL git, ou busque extensões no Open VSX.',
  ...
  'mcp.errJsonc': 'O Flashwork não escreve em opencode.jsonc, para não apagar seus comentários.',
  ...
  'onboarding.mcpSubtitle':
    'O Flashwork lê os servidores MCP que cada agente já tem e copia um para os outros, então uma ferramenta configurada no Claude também funciona no Codex.',
  ...
  'extensions.tab': 'Extensões (beta)',
  'extensions.badge': 'beta',
  'extensions.browse': 'Ver extensões',
  'extensions.search': 'Buscar no Open VSX',
  'extensions.install': 'Instalar',
  'extensions.installing': 'Instalando…',
  'extensions.uninstall': 'Desinstalar',
  'extensions.installed': 'Instaladas neste projeto',
  'extensions.installedBadge': 'Instalada',
  'extensions.installedEmpty': 'Nenhuma extensão instalada neste projeto.',
  'extensions.noProject': 'Abra a pasta de um projeto para instalar extensões.',
  'extensions.loading': 'Buscando no Open VSX…',
  'extensions.offline':
    'Não deu para alcançar o Open VSX e não há nada em cache para esta busca.',
  'extensions.stale': 'Open VSX fora do ar — mostrando a cópia salva em {date}.',
  'extensions.noResults': 'Nenhuma extensão encontrada.',
  'extensions.count': '{count} resultado(s)',
  'extensions.hint':
    'A busca vazia lista temas de cor do Open VSX. Instalar um aplica no editor e no chrome. Gramáticas e pacotes de linguagem também vão para .flashwork/extensions deste projeto.',
  'extensions.applyTheme': 'Usar tema',
  'extensions.appliedTheme': 'Em uso',
  'extensions.themeApplied': '{name} é agora o tema do editor',
  'extensions.incompatibleTitle': 'Esta extensão não é compatível',
  'extensions.incompatibleBody':
    'O Flashwork não executa extensões só de Electron, como debuggers, views ou editores customizados. Temas, gramáticas e pacotes de linguagem são suportados.',
  'extensions.installedOk': '{name} instalada',
  'extensions.installFailed': 'Não deu para instalar a extensão',
  ...
  'skills.installTitle': 'Instalar uma skill',
  'skills.installGit': 'URL do Git',
  'skills.installFolder': 'Pasta local',
  'skills.installHint':
    'Skills instalam a partir de uma pasta local ou de uma URL git. Ainda não há um registry de skills.',
  'skills.installAction': 'Instalar',
  'skills.installed': '{name} instalada',
  'skills.installFailed': 'Não deu para instalar a skill',
  'skills.gitUrl': 'URL do Git',
  'skills.gitUrlPlaceholder': 'https://github.com/org/skill.git',
  'skills.pickFolder': 'Escolher pasta',
  'skills.overwrite': 'Substituir se já existir uma skill com este nome',
  'skills.fieldTargets': 'Também criar link em',
  'skills.fieldTargetsHint':
    'A skill sempre é copiada para o store compartilhado. Marque os agentes que devem receber um link.',
  'skills.errNoSkillMd': 'Essa pasta não tem SKILL.md.',
  'skills.errExists': 'Já existe uma skill instalada com este nome.',
  ...
  'editor.empty': 'Abra um arquivo na barra de Arquivos',
