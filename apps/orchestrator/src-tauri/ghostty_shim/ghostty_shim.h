...
// numa NSView.
//
// Convenção de nomes: tudo prefixado `flashwork_ghostty_`.
#ifndef FLASHWORK_GHOSTTY_SHIM_H
#define FLASHWORK_GHOSTTY_SHIM_H
...
typedef void *flashwork_surface_t;
...
#endif // FLASHWORK_GHOSTTY_SHIM_H
