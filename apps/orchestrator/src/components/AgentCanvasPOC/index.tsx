...
function AgentCanvasInner() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('flashwork:agent-canvas-exit', handler)
    return () => window.removeEventListener('flashwork:agent-canvas-exit', handler)
  }, [])
