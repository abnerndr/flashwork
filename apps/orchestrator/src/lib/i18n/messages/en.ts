export const en = {
  ...
  'onboarding.gitSubtitle':
    'Show repository changes, stage files, and create commits without leaving Flashwork.',
  ...
  'agent.gemini.desc': 'Google Gemini CLI',
  ...
  'profiles.backupFileType': 'Flashwork account backup',
  ...
  'menu.backupFilter': 'Flashwork backup',
  'menu.confirmReset':
  ...
  'remote.description':
    'Scan this QR code from a phone on the same network to open Flashwork Remote.',
  ...
  'onboarding.agentsMissing':
    'Flashwork uses your own provider accounts and subscriptions. Missing a CLI or selected the wrong executable? Scan again or change it later in Preferences > Terminal > CLI paths.',
  'onboarding.agentsRescan': 'Scan again',
  'agentInstall.needsNode':
    'This agent needs Node.js 20+ and npm. Install or upgrade Node, then try again.',
  ...
  'handoff.privacy':
    'The packet stays in your local Flashwork profile and is deleted after the destination agent completes its first turn.',
  'handoff.lossPrivate':
  ...
  'remote.settingsStatusDesc':
    'Control whether Flashwork accepts remote connections on the local network.',
  ...
  'prefs.categoryAccountDesc': 'Manage your local profile, language, and Flashwork accounts.',
  ...
  'prefs.uiThemeDesc': 'Choose the palette used throughout the Flashwork interface.',
  ...
  'prefs.windowOpacityDesc': 'Let the desktop show through the entire Flashwork window.',
  ...
  'prefs.featuresDesc': 'Choose which optional modules are visible in Flashwork.',
  ...
  'features.taskBoard.title': 'Task board',
  'features.taskBoard.description':
    'Kanban queue that plans with a cheap model and runs the work on your installed CLIs.',
  'features.canvasFlows.title': 'Flows (beta)',
  'features.canvasFlows.description':
    'Graph agents, text, filters, HTTP, and MCP tools. Output from one node feeds the next.',
  ...
  'taskBoard.prompt': 'What should happen',
  'taskBoard.files': 'Allowed files',
  'taskBoard.addFiles': 'Add files',
  'taskBoard.filesHint': 'Empty means the whole repo — this card will run alone in that folder.',
  'taskBoard.verify': 'Test commands (optional)',
  'taskBoard.verifyHint': 'One command per line. Falls back to the project validation commands.',
  'taskBoard.attachHandoff': 'Attach handoff',
  'taskBoard.attachNeedPromptOrFile': 'Add a prompt or attach a file before creating the card.',
  'taskBoard.attachmentsHint': 'Markdown handoffs the agent reads when the card starts.',
  'taskBoard.attachOnlyPrompt': 'See attached: {title}',
  'taskBoard.restrictTools': 'Restrict tools',
  'taskBoard.toolsDefault': 'Uses the project defaults for MCP servers and skills.',
  'taskBoard.toolsMcpServers': 'MCP servers',
  'taskBoard.toolsSkills': 'Skills',
  'taskBoard.toolsEmptyServers': 'No MCP servers found for this project.',
  'taskBoard.toolsEmptySkills': 'No skills found.',
  'taskBoard.create': 'Add to backlog',
  'taskBoard.fileCount': '{count} files',
  'taskBoard.wholeRepo': 'Whole repo',
  'taskBoard.openWorkspace': 'Open workspace',
  'taskBoard.stop': 'Stop',
  'taskBoard.column.backlog': 'Backlog',
  'taskBoard.column.todo': 'To do',
  'taskBoard.column.doing': 'Doing',
  'taskBoard.column.verify': 'Test',
  'taskBoard.column.done': 'Done',
  'taskBoard.column.blocked': 'Blocked',
  'taskBoard.error.noCwd':
    'This project has no working folder. Open the workspace or pick a folder, then move the card back to To do.',
  ...
  'flows.title': 'Flows',
  'flows.kicker': 'Beta canvas',
  'flows.lede': 'Drag a node onto the board. Connect output to input. Run pipes one node at a time.',
  'flows.beta': 'Beta',
  'flows.graph': 'Flow',
  'flows.new': 'New flow',
  'flows.run': 'Run',
  'flows.running': 'Running…',
  'flows.inspector': 'Node',
  'flows.inspectorEmpty': 'Select a node to edit its settings.',
  'flows.portIn': 'Input port',
  'flows.portOut': 'Output port',
  'flows.confirmHosts':
    'This flow will request: {hosts}. Continue only if you trust those hosts.',
  'flows.loopbackOn': 'Loopback HTTP (127.0.0.1) is allowed for Flow nodes.',
  'flows.loopbackOff': 'Allow Flow HTTP nodes to call http://127.0.0.1 after confirmation.',
  'flows.node.agent': 'Agent',
  'flows.node.text': 'Text',
  'flows.node.filter': 'Filter',
  'flows.node.http': 'HTTP',
  'flows.node.mcp': 'MCP tool',
  'flows.field.prompt': 'Prompt',
  'flows.field.template': 'Template ({{input}})',
  'flows.field.includes': 'Includes',
  'flows.field.regex': 'Regex',
  'flows.field.jsonPath': 'JSON path',
  'flows.field.method': 'Method',
  'flows.field.url': 'URL',
  'flows.field.server': 'MCP server',
  'flows.field.serverEmpty': 'Select a configured server',
  'flows.field.tool': 'Tool name',
  ...
  'prefs.resourcePolicyManualHint':
    'Flashwork only measures usage. It never closes tabs, parks runtimes or pauses new spawns automatically.',
  ...
  'prefs.cliPathsDesc':
    'Flashwork finds each agent CLI on its own. Override it only when the CLI lives somewhere unusual — and point it at the command-line tool, not at a desktop app.',
  ...
  'prefs.cliCommandDesc':
    "Install the 'flashwork' command so you can open any folder as a project straight from the terminal.",
  ...
  'prefs.cliStale':
    'The installed command points to an older copy of Flashwork. Reinstall it to update the path.',
  'prefs.cliNotOnPath':
  ...
  'prefs.discordPresenceHint': 'Shows that you are using Flashwork without exposing project names.',
  ...
  'prefs.checkUpdatesDesc': 'Check whether a newer version of Flashwork is available to download.',
  'prefs.installedVersion': 'Installed version',
  'prefs.checkNow': 'Check for updates',
  'prefs.checkingUpdates': 'Checking…',
  'prefs.upToDate': 'Flashwork is up to date.',
  ...
  'todo.resetDefault': 'Reset to Flashwork default Todo',
  'todo.resetDefaultConfirm': 'Replace your current Todo list with the Flashwork default list?',
  ...
  'whatsNew.subtitle': 'Flashwork keeps getting sharper.',
  ...
  'whatsNew.v140.note2':
    'The `flashwork` terminal command opens the current folder as a project — or focuses the app if it is already open.',
  'whatsNew.v140.note3':
  ...
  'whatsNew.v130.note8':
    'Experimental window opacity control, to see the desktop through Flashwork.',
  ...
  'home.quickUnrestrictedAutoHint':
    'Auto always accepts CLI allow prompts (YOLO). Pick a specific agent to use Normal mode.',
  'home.quickAgentSessionHint': '{agent}: session {limit}',
  ...
  'home.quickSendAuto': 'Start Auto run',
  ...
  'promptRun.noProjectTitle': 'Pick a project first',
  'promptRun.noProjectBody': 'Auto runs inside an existing project. Create one, then try again.',
  'promptRun.noCwdTitle': 'Choose a folder',
  'promptRun.noCwdBody': 'Auto needs a working folder on that project.',
  'promptRun.runActiveTitle': 'A run is already active',
  ...
  'promptRun.status.done': 'Done',
  'promptRun.status.failed': 'Failed',
  'promptRun.status.cancelled': 'Cancelled',
  'promptRun.status.interrupted': 'Interrupted',
  'promptRun.reason.heuristic': 'Matched the prompt',
  'promptRun.reason.quota': 'Quota',
  'promptRun.reason.error': 'Error',
  'promptRun.reason.user': 'You asked',
  'promptRun.reason.only-installed': 'Only installed CLI',
  'promptRun.reason.project-preference': 'Project preference',
  'promptRun.reason.last-used': 'Last used in this project',
  'promptRun.reason.skill': 'Matched a skill',
  'promptRun.reason.orchestrator': 'Orchestrator',
  'promptRun.barTitle': 'Auto run',
  'promptRun.sessionLimitHint': '{agent} session limit: {limit}',
  'promptRun.reviewCapsule': 'Review capsule',
  'promptRun.cancel': 'Stop Auto',
  'promptRun.composerPlaceholder': 'Continue with Auto…',
  'promptRun.composerSend': 'Auto',
  'promptRun.handoffToastTitle': 'Handed off to {agent}',
  'promptRun.handoffToastBody': '{reason}. The previous pane is still open.',
  'promptRun.handoffBlockedTitle': 'Could not hand off',
  'promptRun.handoffBlockedBody': '{detail}',
  'promptRun.handoffNoPeer': 'No other coding CLI is installed to continue.',
  'interruptedResume.title': 'Resume interrupted Auto',
  'interruptedResume.lede':
    'These Auto or Task Board runs were still active when Flashwork quit or crashed. Resume continues with Auto for up to 7 days.',
  'interruptedResume.resume': 'Resume in Auto',
  'interruptedResume.discard': 'Discard',
  'interruptedResume.dismissAll': 'Dismiss all',
  'interruptedResume.resumedTitle': 'Auto resumed',
  'interruptedResume.resumedBody': 'A new Auto run started from the interrupted work.',
  'interruptedResume.failedTitle': 'Could not resume',
  'interruptedResume.failedBody': 'Install a coding CLI or add a provider key, then try again.',
  'taskBoard.needsResume': 'Interrupted — resume in Auto',
  'taskBoard.resumeAuto': 'Resume in Auto',
  ...
  'widget.sessionWindowUsage': 'usage {window}',
  ...
  'widget.geminiNoUsage': 'no usage today',
  'widget.geminiNoUsageHint': 'run gemini today to see tokens here',
  'widget.geminiTouchedToday': 'session totals · touched today',
  'widget.costLabel': 'cost',
  ...
  'crud.folderRequired': 'Choose a project folder.',
  'crud.flashworkExists': 'This folder already belongs to a Flashwork project.',
  'crud.openExisting': 'Open this folder as project',
  ...
  'browser.resourceModeAppFirst': 'Prioritize Flashwork',
  ...
  'browser.resourceModeDescription.keep-alive':
    'Keeps hidden pages loaded, but still releases them if Flashwork detects memory pressure.',
  'browser.addToGrid': 'Add to grid',
  'browser.privateTitle': 'Private session is always on',
  'browser.privateDescription':
    'Flashwork opens this pane in a native incognito webview. Cookies, logins, cache, autofill, and site storage are not kept after the pane closes.',
  'browser.privateBadge': 'Private',
  'browser.destination': 'This browser will be added to {project}.',
  'browser.embedHint': 'Opens inside Flashwork. Some sites may block embedded viewing.',
  ...
  'mod.health.normal.body':
    'Windows has {available} available out of {total}. Flashwork will not close tabs automatically.',
  ...
  'mod.health.critical.body':
    'Windows has only {available} available out of {total}. Flashwork will warn, but any session closure remains your decision.',
  ...
  'appClose.title': 'Close Flashwork?',
  'appClose.message':
    'Open agents and terminals will be stopped. Saved conversations can be resumed the next time you open Flashwork.',
  'appClose.confirm': 'Close Flashwork',
  'appClose.cancel': 'Cancel',
  'appClose.failedTitle': 'Flashwork could not close',
  ...
  'ui.sidebar.tasksTitle': 'Task board',
  'ui.sidebar.flows': 'Flows',
  'ui.sidebar.flowsTitle': 'Flows (beta)',
  ...
  'files.dragHint':
    '{path} — drag to the workspace, or click to open',
  ...
  'git.fetch.action': 'Fetch',
  'git.fetch.title': 'Fetch from remotes',
  'git.fetch.done': 'Fetched from remotes',
  'git.push.action': 'Push',
  'git.push.title': 'Push to remote',
  'git.push.done': 'Pushed to remote',
  'git.pull.action': 'Pull',
  'git.pull.title': 'Pull from remote',
  'git.pull.done': 'Pulled from remote',
  'git.publish.action': 'Publish',
  'git.publish.title': 'Publish branch',
  'git.publish.done': 'Published branch',
  'git.origin.label': 'Origin URL',
  'git.origin.placeholder': 'https://github.com/owner/repo.git',
  'git.pullRequest.action': 'Open pull request',
  'git.pullRequest.title': 'Open pull request on GitHub',
  ...
  'git.github.signIn': 'Sign in to GitHub',
  'git.github.title': 'Sign in to GitHub',
  'git.github.hint': 'Copy the code, then authorize Flashwork on GitHub.',
  'git.github.copy': 'Copy code',
  'git.github.copied': 'Copied',
  'git.github.openDevice': 'Open GitHub',
  'git.github.starting': 'Starting sign-in…',
  'git.github.waiting': 'Waiting for authorization…',
  ...
  'ws.confirmOverwriteForeignAgent':
    'An agent "{name}" that was NOT created by Flashwork already exists in this project. Overwrite?',
  'ws.confirmRemoveAgent': 'Remove the agent "{name}" from the project?',
  'ws.confirmRemoveForeignAgent':
    'The agent "{name}" was NOT created by Flashwork. Remove it anyway?',
  ...
  /* ---- crash watch ---- */
  'crash.uncleanTitle': 'Flashwork closed unexpectedly',
  ...
  'update.checkFailedBody':
    'Flashwork could not reach the update service. Check your connection and try again.',
  ...
  'prefs.aboutVersionDesc': 'The Flashwork build currently installed.',
  'prefs.aboutUpdatesTitle': 'Updates',
  'prefs.aboutUpdatesDesc': 'Check for and install new versions of Flashwork.',
  ...
  'update.checkSuccessTitle': 'Flashwork is up to date',
  ...
  'resource.warning.body':
    'Flashwork is using about {total} MB. Hidden idle runtimes may be parked.',
  'resource.critical.title': 'Memory budget reached',
  'resource.critical.body':
    'Flashwork is using about {total} MB. New runtimes are paused until memory recovers.',
  ...
  'menu.logsFilter': 'Flashwork logs',
  'sandbox.eyebrow': 'Experimental orchestration',
  'sandbox.title': 'Agent Sandbox',
  'sandbox.subtitle':
    'A real planner-to-worker POC: Claude Code plans, Codex implements, and Flashwork relays the handoff.',
  ...
  'mcp.marketplaceHint':
    'Add MCP servers from the registry, install skills from a folder or git URL, or browse Open VSX extensions.',
  ...
  'mcp.errJsonc': 'Flashwork does not write opencode.jsonc, to avoid stripping your comments.',
  ...
  'onboarding.mcpSubtitle':
    'Flashwork reads the MCP servers each agent already has and can copy one across the others, so a tool set up in Claude also works in Codex.',
  ...
  'extensions.tab': 'Extensions (beta)',
  'extensions.badge': 'beta',
  'extensions.browse': 'Browse extensions',
  'extensions.search': 'Search Open VSX',
  'extensions.install': 'Install',
  'extensions.installing': 'Installing…',
  'extensions.uninstall': 'Uninstall',
  'extensions.installed': 'Installed in this project',
  'extensions.installedBadge': 'Installed',
  'extensions.installedEmpty': 'No extensions installed in this project.',
  'extensions.noProject': 'Open a project folder to install extensions.',
  'extensions.loading': 'Searching Open VSX…',
  'extensions.offline':
    'Could not reach Open VSX and there is no cached result for this search.',
  'extensions.stale': 'Open VSX unreachable — showing the copy saved on {date}.',
  'extensions.noResults': 'No extension matched.',
  'extensions.count': '{count} result(s)',
  'extensions.hint':
    'Empty search lists Open VSX color themes. Install one to apply it to the editor and workbench chrome. Grammars and language packs also install into this project’s .flashwork/extensions folder.',
  'extensions.applyTheme': 'Use theme',
  'extensions.appliedTheme': 'In use',
  'extensions.themeApplied': '{name} is now the editor theme',
  'extensions.incompatibleTitle': 'This extension is not compatible',
  'extensions.incompatibleBody':
    'Flashwork cannot run Electron-only extensions such as debuggers, views, or custom editors. Themes, grammars, and language packs are supported.',
  'extensions.installedOk': '{name} installed',
  'extensions.installFailed': 'Could not install the extension',
  ...
  'skills.installGit': 'Git URL',
  'skills.installFolder': 'Local folder',
  'skills.installHint': 'Skills install from a local folder or a git URL. There is no skills registry yet.',
  'skills.installAction': 'Install',
  'skills.installed': '{name} installed',
  'skills.installFailed': 'Could not install the skill',
  'skills.gitUrl': 'Git URL',
  'skills.gitUrlPlaceholder': 'https://github.com/org/skill.git',
  'skills.pickFolder': 'Choose folder',
  'skills.overwrite': 'Replace if a skill with this name already exists',
  'skills.fieldTargets': 'Also link into',
  'skills.fieldTargetsHint': 'The skill is always copied into the shared store. Tick agents that should get a link.',
  'skills.errNoSkillMd': 'That folder has no SKILL.md.',
  'skills.errExists': 'A skill with this name is already installed.',
  ...
  'editor.empty': 'Open a file from the Files sidebar',
