...
> Projeto: **Flashwork** (app desktop Tauri 2 + React/TS, `D:\Projetos\flashwork-agents`).
...
- **HMR de store Zustand NÃO é automático** pro corpo das actions — editar um
  ...
  **Se algo continuar "com bug antigo" mesmo depois de um fix, a explicação mais
  ...
  código novo está rodando depois de um reload da janela do Flashwork (F5/Ctrl+R) ou
