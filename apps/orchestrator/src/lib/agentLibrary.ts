...
const MARKER = '<!-- gerado pelo Flashwork (biblioteca) — seguro deletar -->'
...
Você é o tech-lead/planejador de uma sessão de orquestração do Flashwork. O control plane (lead) te consulta no começo de uma meta grande e nos marcos pra decidir o que distribuir e em que ordem.
