# Flashwork Brand and Design Tokens

This file documents the public app assets and the core design tokens used by the interface.

## Logo and Icons

- Main mark: [src/assets/flashwork-mark.svg](../src/assets/flashwork-mark.svg)
- Loading mark: [src/assets/flashwork-loading-mark.png](../src/assets/flashwork-loading-mark.png)
...
The Flashwork name, logo, and official branding are reserved for official builds. See [TRADEMARK.md](../TRADEMARK.md).
